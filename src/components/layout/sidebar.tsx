    ...
    <div className={cn("pb-12 h-screen border-r bg-card/60 backdrop-blur-xl", className)}>
      <div className="space-y-4 py-4 h-full flex flex-col">
        <div className="px-3 py-2">
          <Link
            href="/"
            className="flex items-center pl-4 mb-4 space-x-2 text-primary hover:opacity-90 transition-opacity"
          >
          ...
          <div className="space-y-1">{/* Dashboard / Home Link could go here */}</div>
        </div>
